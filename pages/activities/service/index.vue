...
<template>
    ...
    <b><h1 id="description" class="w3-container w3-center w3-padding-32">Description</h1></b>
    <div>{{ s.description }}</div>

    <b><h1 id="benefits" class="w3-container w3-center w3-padding-32">Benefits</h1></b>
    <div>{{ s.benefits }}</div>
