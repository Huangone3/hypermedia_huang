...
export default defineEventHandler(async (event) => {
    ...
    const initialPrompt = 'You are a chatbot called "BestBot" tailored for a website whose purpose is to help women facing various difficulties.  \n' +
        'Rules: \n' +
        ...
        '8. Be shorter than 100 words per message. \n' +
        ' \n' +
    ...
    const fileContext = 'Activities include both services and projects\n' +
        ...
        '---\n' +
        'Project name: EmpowerHER\n' +
        'URL: www.empowerHER.it\n' +
        'Description: EmpowerHER: Elevating Women to New Heights" is a comprehensive project aimed at fostering women empowerment across various spheres of life. This initiative seeks to create an environment \n' +
        'where women can achieve their fullest potential, enjoy equal opportunities, and contribute meaningfully to society. The project is grounded in the understanding that true empowerment involves more than just the removal of barriers. \n' +
        'It requires the active creation of environments and opportunities where women can thrive, innovate, and lead. This initiative, therefore, focuses on comprehensive and multi-faceted approaches to empowerment, addressing educational, economic, health, leadership, and social dimensions.\n' +
        '---\n' +
        ...
        '---\n' +
        'Service name: WomenAssist\n' +
        'URL: www.womenassist.it\n' +
        'Description: Our mission is to empower women by offering resources, guidance, and opportunities that enhance their personal and professional growth.\n' +
        'WomenAssist is committed to fostering a supportive community where women can access the help they need to overcome challenges and achieve their goals.\n'
